...
<title>Sollibyte confirmation page</title>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<br>
						<br>
						<h3 class="text-center "><a href="confirmationResponse?subStrandName=nothing" class="text-danger">Yes ?</a></h3>

						<h3 class="text-center "><a href="showAssessLearnerFirstForm" class="text-success">No ?</a></h3>
