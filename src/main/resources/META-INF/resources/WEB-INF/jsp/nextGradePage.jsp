...
<title>Sollibyte next grade page</title>
                ...
                <div class="container col-md-6">
                    ...
                    <div class="row text-center">
                        <div>
                            <br>
                            <br>
                            <h2 style="color: #0fad00">Move to the next Grade?</h2>
                            <h3 class="text-danger">Warning !</h3>
                            <br>
                            <p style="font-size: 20px; color: #5C5C5C;">
                                Moving to the next grade should be done at the end of the academic year only
                                Remember this option cannot be undone.This means that a new grade will be created
                                that is one year ahead  e.g grade 1 changes to grade 2
                            </p>
                            <br>
                            <h4 class="text-danger">This action cannot be undone</h4>
                            <br> <a href="confirmNextGradeRequest" class="btn btn-sm btn-info"> Proceed <i class="fa fa-arrow-right" aria-hidden="true"></i></a> <br>
