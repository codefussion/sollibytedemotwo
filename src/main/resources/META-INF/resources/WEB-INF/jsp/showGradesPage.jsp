...
<title>Sollibyte show grade page</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="text-info text-h4"> Select the grade(s) that you teach
                                        ...
                                        <div class="form-check">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="checkbox"
                                                    class="form-check-input" id="check2" name="gradeIds"
                                                    value="${grade.gradeId}"></td>
                                                <td>${grade.gradeDisplayNumber}</td>
                                                <td>${grade.gradeStream}</td>
                                                <td>${grade.year}</td>
