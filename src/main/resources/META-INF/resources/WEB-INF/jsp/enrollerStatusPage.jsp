...
<title>Sollibyte enroller status page</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="Profiles" class="list-group-item list-group-item-action bg-light text-primary">Enroller Status</a>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="container search-table">
                        <h4 class="text-center text-danger"> Enroller Status</h4>
                            ...
                            <form>
                                ...
                                <table class="table table-striped table-bordered  table-hover"
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${enrollers}" var="enroller">
                                            <tr>
                                                <td><a class="text-primary" href="enrollerSchools?enrollerPhoneNumber=${enroller.phoneNumber}">${enroller.last_name}</a></td>
                                                <td><a class="text-primary" href="enrollerSchools?enrollerPhoneNumber=${enroller.phoneNumber}">${enroller.idNumber}</a></td>
                                                <td><a class="text-primary" href="enrollerSchools?enrollerPhoneNumber=${enroller.phoneNumber}">${enroller.phoneNumber}</a></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
