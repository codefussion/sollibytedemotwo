...
<title>Sollibyte class teacher first page</title>
			...
			<div class="container-fluid">
							...
							<div class="card-body">
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										...
										<div class="row no-gutters align-items-center">
											<div class="col-auto">
												<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Class Teacher</div>
											</div>
											<div class="col">
								...
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div
											class="text-xs font-weight-bold text-success text-uppercase mb-1">
											Term-${grade.term}</div>
										<div class="h5 mb-0 font-weight-bold text-gray-800">Ended: ${grade.termEnded}</div>
									</div>
									<div class="col-auto">
				...
				<div class="col-lg-6">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<p>
									<b class="text-info">Teacher Name:</b>${classTeacher.first_name} ${classTeacher.last_name}
								</p>
								<p>
									<b class="text-info">Role:</b> Class Teacher
								</p>
								<p>
									<b class="text-info">Phone Number:</b> ${classTeacher.phoneNumber}
								</p>
								<a class="btn btn-primary btn-sm" href="changeClassTeacherNamePage?phoneNumber=${classTeacher.phoneNumber}" role="button">Change name?</a>
								<a class="btn btn-primary btn-sm" href="changeClassTeacherPhoneNumber?phoneNumber=${classTeacher.phoneNumber}" role="button">Change Phone Number?</a>
							</div>
						</div>
				</div>		
              ...
              <div class="col-lg-6">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<p>
									<b class="text-info">Grade:</b>${grade.gradeNumber} ${grade.gradeStream}
								</p>
								<p>
									<b class="text-info">Year:</b> ${grade.year}
								</p>
								<p class="text-danger">
									<b class="text-danger">Please click below before ending the term</b>  
								</p>
								 <a href="matchAll" class="btn btn-danger btn-sm active" role="button">Press here</a>
							</div>
						</div>
								...
								<table class="table table-striped table-bordered  table-hover"
									...
									<tbody>
										...
										<tr>
											...
											<td><a class="text-success" href="viewLearnerProfile?learnerId=${learner.learnerId}">view</a></td>
