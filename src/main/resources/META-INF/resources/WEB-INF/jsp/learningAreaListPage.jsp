...
<title>Sollibyte learning area list page</title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="container search-table">
                    <a class="btn btn-danger text-right  btn-sm" href="verifyClassTeacherDuplicate" role="button"> <i class="fa fa-arrow-left" aria-hidden="true"></i>   Back</a>

                   <a href="matchAll" class="btn btn-danger btn-sm active" role="button">Match All</a>
                                ...
                                <tbody>
                                    <c:forEach items="${learningAreas}" var="learningArea">
                                        ...
                                        <tr>
                                            ...
                                            <td>${learningArea.learningAreaName}</td>
                                            <td><a href="matchLearnersToLearningArea?learningAreaId=${learningArea.learningAreaId}" class="btn btn-primary btn-sm active" role="button">Match learners</a></td>
