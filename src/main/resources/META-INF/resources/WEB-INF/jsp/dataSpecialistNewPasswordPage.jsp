...
<html>
<head>
	<title>Sollibyte data specialist new password page</title>
...
<body>
    ...
    <div class="d-flex flex-column justify-content-between">
       <form action="changeDataSpecialistPassword">
               <div class="card mt-3 p-5">
            <div class="logo mb-3"><img src=""></div>
            <div>
                
                <h4 class="mb-5 text-white text-center">Enter & Confirm new password</h4>
            </div>
        ...
        <div class="card two bg-white px-5 py-4 mb-3">
            <div class="form-group"><input type="text" class="form-control" name="newPass" id="number" required><label class="form-control-placeholder" for="number">Enter new Password</label></div>
            <div class="form-group"><input type="text" class="form-control" name="passConfirm" id="password" required><label class="form-control-placeholder" for="password">Confirm Password</label></div>
