...
<title> Sollibyte class teacher login form</title>
		...
		<div class="d-flex flex-column justify-content-between">
			<div class="card mt-3 p-5">
				...
				<div>
					...
					<h4 class="mb-5 text-white text-center">Class teacher login</h4>
				</div>
				<a style="margin-bottom:1px;" href="classTeacherRestore" role="button" class="btn btn-primary btn-lg"><small>Forgot password?</small><span>&nbsp;forgot</span></a>
			...
			<div class="card two bg-white px-5 py-4 mb-3">
				<form action="verifyClassTeacher">
				<div class="form-group">
					<input type="text" class="form-control" name="phoneNumber" id="number" required><label
						class="form-control-placeholder" for="number">Phone Number</label>
						<p class="text-danger">${msgOne}</p>
				</div>
				<div class="form-group">
					<input type="password" name="password" class="form-control" id="password" required><label
