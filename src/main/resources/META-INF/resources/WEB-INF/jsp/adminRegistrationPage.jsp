...
<html>
<head>
	<title>Sollibyte admin registration page</title>
    ...
    <div class="d-flex flex-column justify-content-between">
        <div class="card mt-3 p-5">
            ...
            <div>
                ...
                <h4 class="mb-5 text-white text-center">Admin Registration</h4>
            </div><a href="adminLogin" role="button" class="btn btn-primary btn-lg"><small>Already registered?</small><span>&nbsp;Login</span></a>
        </div>
        <div class="card two bg-white px-5 py-4 mb-3">
            ...
            <div class="form-group"><input type="text" class="form-control" id="number" name="first_name" required><label class="form-control-placeholder" for="number">Enter first name</label></div>
              ...
              <div class="form-group"><input type="text" class="form-control" id="number" name="phone_number" required><label class="form-control-placeholder" for="number">Enter phone number</label></div>
