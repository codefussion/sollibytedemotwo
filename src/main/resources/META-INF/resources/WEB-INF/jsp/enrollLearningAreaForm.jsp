...
<title>Sollibyte enroll learning area form</title>
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            <div class="sidebar-heading "><p class="h4 text-center text-success">Solidarity</p></div>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-center text-info">Register Learning Area</h4>
                        
                        <form action="saveLearningArea" name="myform" method="post" onsubmit ="return verifyPassword()">
                        <p class="text-success">${msgOne}</p>
                            <div class="form-group">
                                <label for="email" class="text-success">Enter Learning Area</label> <input
                                    type="text" class="form-control" id="text"
                                    placeholder="Enter learning Area name" name="learning_area_name">
