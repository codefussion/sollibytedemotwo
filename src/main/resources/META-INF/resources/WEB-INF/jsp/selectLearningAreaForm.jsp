...
<title>Sollibyte select learning area form page</title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-center text-info">Select Learning Area that
                            you teach</h4>
                        <p class="text-danger">${msg}</p>
                        <form action="saveLearningAreaFromSubjectTeacher" name="myform"
                            ...
                            <div class="form-group">
                                <label for="username">Enter Grade Stream </label> <input
                                    ...
                                    name="gradeStream">${msgTwo} <span id="txt3"
                            ...
                            <div class="form-group">
                                ...
                                </select> ${msgTwo} <span id="txt4" style="color: red"> </span>
