...
<title>Sollibyte start term page </title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h4 class="text-center text-info">Select Term To start</h4>
                <div class="col-md-3"></div>
                <div class="container col-md-6">
                    <form action="initiateTerm">
                        <div class="form-group">
                           

                         <p class="text-danger">${msg}</p>

                            <label for="sel1" class="text-success">Select Term (select one):</label> 
                        ...
                        <button type="submit" class="btn btn-info btn-sm text-center">Submit</button>
                    </form>
                </div>
