...
<title>Sollibyte accept learner page</title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-center text-info">Accept Learner</h4>
                        
                        <form action="acceptLearnerAction">
                            <div class="form-group">
                                
                                <label for="email" class="text-success">Enter learner Nemiss Number</label> <input
                                    type="text" class="form-control" id="email"
                                    placeholder="Enter Nemiss Number" name="nemissNumber">
                                    ${msg}
                            </div>
