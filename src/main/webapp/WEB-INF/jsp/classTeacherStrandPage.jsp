...
<html>
<head>
<title>Sollibyte  class teacher strand page </title>
	...
	<div class="row main">
		...
		<div class="col-lg-6">
			...
			<div class="card shadow mb-4">
				<a class="btn btn-primary   btn-sm" href="viewLearnerProfileDuplicate?confirm=false"
					role="button">Back</a>
					...
					<table class="table table-sm ">
						...
						<tbody>
							<c:forEach items="${strands}" var="strand">
								<tr>
									<td><a
										href="showScoresClassTeacher?strandId=${strand.strandId}">${strand.strandName}</a></td>
								</tr>
							</c:forEach>
