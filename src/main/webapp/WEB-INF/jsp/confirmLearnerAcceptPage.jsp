...
<html>
<head>
<title>Sollibyte confirm learner accept page </title>
	...
	<div class="row main">
		...
		<div class="col-md-6">
			<div class="jumbotron text-center mainTwo">
				...
				<p class="lead">Learner Name: ${learner.firstName} ${learner.secondName} ${learner.surName}</p>
				<p class="lead">Nemiss Number: ${learner.nemissNumber}</p>
					<a class="btn btn-primary btn-sm" href="classTeacherHomePage"
						role="button">Back</a>
				</p>
			</div>
