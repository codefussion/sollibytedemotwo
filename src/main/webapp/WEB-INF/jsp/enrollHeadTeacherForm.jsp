...
<title>Sollibyte enroll head teacher form </title>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-center text-info">Enroll Head Teacher</h4>
                        <form action="saveHeadTeacher" name="myform" onsubmit="return validateform()" method="post">
                        <p class="text-danger"> ${msg}</p>
                            <div class="form-group">
                                <label for="phone-number">Enter School Name</label> <input
                            ...
                            <div class="form-group">
                                <label for="email">Enter School Code Number</label> <input
                                    type="text" class="form-control" id="email"
                                    placeholder="Enter school  code number" name="codeNumber">
