...
<title>Sollibyte assess learner first form</title>
...
var strandName =document.myform.strandName.value; 
...
else if (learningAreaName==null || learningAreaName==""){  
   document.getElementById("txt3").innerHTML = "Please fill in the blank!";
  return false;  
}
else if (strandName==null || strandName==""){  
        ...
        <div id="page-content-wrapper">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        <li class="nav-item active"><a class="nav-link text-primary"
                            href="verifySubjectTeacherDuplicate">Home <span
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-center text-info">Assess your learners</h4>
                        <p class="text-danger">${msg}</p>
                        <form action="verifyAssessLearner" name="myform"
                            onsubmit="return validateform()">
                            <div class="form-group">
                                <label for="email">Enter year</label> <select
                            ...
                            <div class="form-group">
                                <label for="username">Enter Grade Stream </label> <input
                                    ...
                                    name="gradeStream"> <span id="txt2" style="color: red">
                                </span> ${msgTwo}
                            </div>
                            <div class="form-group">
                                <label for="schoolCode">Enter learning Area Name </label> <input
                                    type="text" class="form-control" id="schoolCode"
                                    placeholder="Enter Learning Area Name" name="learningAreaName">
                                <span id="txt3" style="color: red"> </span> ${msgOne}
                            </div>
                            <div class="form-group">
                                <label for="schoolCode">Enter Strand </label> <input type="text"
                                    class="form-control" id="schoolCode"
                                    placeholder="Enter the strand to assess learners"
                                    name="strandName"> <span id="txt4" style="color: red">
                                </span> ${msgOne}
                            </div>
                            <div class="form-group">
                                <label for="schoolCode">Enter Sub Strand </label> <input
                                    type="text" class="form-control" id="schoolCode"
                                    placeholder="Enter Sub Strand This field is optional"
                                    name="subStrandName"> ${msgOne}
                            </div>


                            <a class="btn btn-danger   btn-sm"
                                href="verifySubjectTeacherDuplicate" role="button"> <i
