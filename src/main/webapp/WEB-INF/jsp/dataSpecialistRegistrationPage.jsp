...
<html>
<head>
	<title>Sollibyte data specialist registration page</title>
    ...
    <div class="d-flex flex-column justify-content-between">
        <div class="card mt-3 p-5">
            ...
            <div>
                ...
                <h4 class="mb-5 text-white text-center">Data Specialist Registration</h4>
        ...
        <div class="card two bg-white px-5 py-4 mb-3">
            <form action="saveDataSpecialistRequest" method="post">
               
            <div class="form-group"><input type="text" class="form-control" id="number" name="firstName" required><label class="form-control-placeholder" for="number">Enter first name</label></div>
              
              <div class="form-group"><input type="text" class="form-control" id="number" name="secondName" required><label class="form-control-placeholder" for="number">Enter second name</label></div>

               <div class="form-group"><input type="text" class="form-control" id="number" name="lastName" required><label class="form-control-placeholder" for="number">Enter last name</label></div>
