...
<html>
<head>
<title>Sollibyte Enroller school number page</title>
    ...
    <div class="row main">
        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow mb-4">
                <a class="btn btn-primary   btn-sm" href="enrollerProfiles"
                    role="button">Back</a>
                <div class="card-header py-3">
                    <h4 class="text-center text-success">Number of Schools enrolled
                    </h4>
                </div>
                <div class="card-body">
                        
                        <p class="text-info h1 text-center">${schoolNumber}</p>
