...
<title>Sollibyte search school page</title>
...
function verifyPassword() {
      var name = document.myform.learning_area_name.value;
...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <a href="enterDataRequest" class="list-group-item text-info list-group-item-action bg-light text-primary">Enter Data</a>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-center text-info">School search</h4>
                        <form action="searchSchool" name="myform" method="post" onsubmit ="return verifyPassword()">
                            <div class="form-group">
                                <label for="email " class="text-success">Enter School Code Number</label> <input
                                    type="text" class="form-control" id="text"
                                    placeholder="Enter School Code Number" name="schoolCodeNumber">
                                    <span id="txt" style="color:red">${msg} </span> 
                                    
                            </div>
                            <a class="btn btn-danger   btn-sm" href="dataSpecialistLoginVerificationDuplicate" role="button"> <i class="fa fa-arrow-left" aria-hidden="true"></i>   Back</a>
