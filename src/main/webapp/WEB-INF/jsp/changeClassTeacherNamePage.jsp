...
<title>Sollibyte change class teacher name page</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <li class="nav-item active">
              <a class="nav-link text-primary" href="verifyClassTeacherDuplicate">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h4 class="text-center text-info">Change username(s)</h4>
                        <p class="text-success">${msg}</p>
                        <form action="changeClassTeacherNameAction" name="myform" onsubmit="return validateform()" method="post">
                            <div class="form-group">
                                <label for="email" class="text-primary">Enter first name</label> <input
                                    type="text" class="form-control" id="email"
                                    placeholder="Enter first name" name="firstName">
                                    <span id="txt" style="color:red"> </span> 
                                    <br>
                                    <label for="email" class="text-primary">Enter second name</label> <input
                                    type="text" class="form-control" id="email"
                                    placeholder="Enter second name" name="secondName">
                                    <span id="txt2" style="color:red"> </span> 
                                    <br>
                                    <label for="email" class="text-primary">Enter last name</label> <input
                                    type="text" class="form-control" id="email"
