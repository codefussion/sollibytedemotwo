...
<title>Sollibyte transfer learner page </title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="text-center text-success">${grade.school.schoolName}</h3>
                <h3 class="text-center text-success">Grade: ${grade.gradeDisplayNumber} ${grade.gradeStream} ${grade.year}</h3>
                    <h4 class="text-center text-success">Term: ${grade.term}</h4>
                                ...
                                <tbody>
                                    <c:forEach items="${learners}" var="learner">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="verifyTransfer?learnerId=${learner.learnerId}">Transfer</a></td>
