...
<html>
<head>
	<title>Sollibyte data specialist restore page</title>
...
<body>
    ...
    <div class="d-flex flex-column justify-content-between">
       <form action="verifyRestoreDataSpecialist">
        ...
        <div class="card two bg-white px-5 py-4 mb-3">
            ...
            <div class="form-group"><input type="text" class="form-control" name="nationalIdNumber" id="password" required><label class="form-control-placeholder" for="password">Enter national Id number</label></div>
