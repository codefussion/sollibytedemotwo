...
<title>Sollibyte learner learning area performance page</title>
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div
                      ...
                      Year</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">${learner.grade.year}</div>
                  </div>
                  <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                    <div
                      ...
                      School Code</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800 text-center">0000${learner.school.schoolId}</div>
                  </div>
                  <div class="col-auto">
          ...
          <div class="col-lg-6">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <p>
                  <b class="text-info">L.A</b> <a href="showStrandSubjectTeacher?learningAreaId=${learningArea.learningAreaId}">${learningArea.learningAreaName} </a> 
                </p>
                <p>
