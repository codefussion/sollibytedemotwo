...
<title>Sollibyte end term page </title>
                ...
                <div class="container col-md-6">
                    ...
                    <div class="row text-center">
                        <div>
                            <br>
                            <br>
                            <h2 style="color: #0fad00">End Term ${term}?</h2>
                            <h3 class="text-danger">Warning !</h3>
                            <br>
                            <p style="font-size: 20px; color: #5C5C5C;">Ending the term
                                will finalize term ${term} learners' academic report generation.
                                This means that term ${term} final academic reports will be
                                created and saved for future reference do you want to continue?
                            </p>
                            <br>
                            <h4 class="text-danger">This action cannot be undone</h4>
                            <br> <a href="confirmEndTerm" class="btn btn-info btn-sm"> End Term</a> <br>
                            <br>
