...
<html>
<head>
<title>Sollibyte subject teacher score page</title>
	...
	<div class="row main">
		...
		<div class="col-lg-6">
			...
			<div class="card shadow mb-4">
				<a class="btn btn-primary   btn-sm" href="showStrandSubjectTeacherDuplicate"
					role="button">Back</a>
				<div class="card-header py-3">
					<h4 class="text-center text-success">Sub-strands in ${strandName}
					</h4>
				</div>
				<div class="card-body">
					<table class="table table-sm ">
						...
						<tbody>
							<c:forEach items="${scores}" var="score">
								<tr>
									<td>${score.subStrand.subStrandName}</td>
